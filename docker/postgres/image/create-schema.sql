...
create table OrderLine(orderId varchar, orderLineId varchar, productId varchar, quantity integer, userId varchar, status varchar, createdDate date, createdTime time, primary key (orderId, orderLineId));
