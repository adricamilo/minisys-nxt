...
public class OrderDBConfiguration {
    ...
    public DataSource postgresOrderDataSource() {
    ...
    @ConditionalOnProperty(name = "database.type", havingValue = "SQL")
    public JdbcTemplate orderJdbcTemplate(DataSource postgresOrderDataSource) {
        return new JdbcTemplate(postgresOrderDataSource);
    }
